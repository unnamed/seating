...
import team.unnamed.chairs.adapt.v1_16_R3.chair.ChairEntityHandler1_16_R3;
import team.unnamed.chairs.adapt.v1_16_R3.hook.WorldGuardHookManager1_16_R3;
import team.unnamed.chairs.adapt.v1_16_R3.intercept.PacketInterceptorAssigner1_16_R3;
import team.unnamed.chairs.adapt.v1_16_R3.intercept.PacketInterceptorRegister1_16_R3;

public class AdaptionModule1_16_R3 implements AdaptionModule {

    @Override
    public ChairEntityHandler getChairEntityHandler() {
        return new ChairEntityHandler1_16_R3();
    }
